<%@ Page Language="VB" AutoEventWireup="false" CodeFile="clientes-empresas-lis.aspx.vb" Inherits="Clientes_clientes_empresas_lis" %>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        <p>
                            ...
                            <i class="med-font">
                                Utilice la opcion <strong>Buscar</strong> para buscar una Empresa en especifico utilizando su <strong>Clave.</strong>. </br>
                                Utilice la opcion <strong>Ver Todos</strong> para visualizar todas las Empresas de la base de datos.
                            </i>
                        </p>
                    </div>
                </div>
