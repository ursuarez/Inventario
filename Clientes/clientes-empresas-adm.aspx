<%@ Page Language="VB" AutoEventWireup="false" CodeFile="clientes-empresas-adm.aspx.vb" Inherits="Clientes_clientes_empresas_adm" %>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="clientes-empresas-adm.aspx" class="list-group-item active"><span class="glyphicon glyphicon-folder-open"></span>&nbsp &nbsp Administrar Empresas</a>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        <p>
                            ...
                            <i class="med-font">
                                Utilice la opcion <strong>Insertar</strong> para agregar una nueva Empresa a la base de datos. </br>
                                Utilice la opcion <strong>Modificar</strong> para modificar los registros de alguna Empresa especificando su <strong>Clave.</strong> </br>
                                Utilice la opcion <strong>Eliminar</strong> para eliminar una Empresa de la base de datos especificando su numero de <strong>Clave.</strong>
                            </iclass="med-font">
                        </p>   
                    </div>
                </div>
