<%@ Page Language="VB" AutoEventWireup="false" CodeFile="clientes-empresas-adm-BORRAR.aspx.vb" Inherits="clientes_empresas_adm_BORRAR" %>
...
<head runat="server">
    ...
    <link rel="icon" href="../img/leaf.png" type="image/x-icon"/>
        <title>Leaf :: Eliminar Empresa</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        ...
                        <form id="form1" runat="server" class="form-horizontal">
                            ...
                            <h3 style="text-align: right" class="gray">Eliminar Empresa</h3>
                        ...
                        <!-- Formulario -->
                            ...
                            <br />
                            <a href = "clientes-empresas-adm-BORRAR.aspx" class = "btn" role = "button"><span class="glyphicon glyphicon-erase"></span>&nbsp Limpiar</a>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FacturacionConnectionString %>" SelectCommand="ELIMINAR_EMPRESA" SelectCommandType="StoredProcedure">
                                <SelectParameters>
