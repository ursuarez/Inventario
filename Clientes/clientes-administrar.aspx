<%@ Page Language="VB" AutoEventWireup="false" CodeFile="clientes-administrar.aspx.vb" Inherits="Clientes_clientes_administrar" %>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                       <p>
                        ...
                        <i class="med-font">
                          Utilice la opcion <strong>Insertar</strong> para agregar un nuevo Cliente a la base de datos. </br>
                          Utilice la opcion <strong>Modificar</strong> para modificar los registros de algun Cliente especificando su <strong>Clave.</strong> </br>  
                          Utilice la opcion <strong>Eliminar</strong> para eliminar un Cliente de la base de datos especificando su numero de <strong>Clave.</strong>   
                        </i></p> 
