<%@ Page Language="VB" AutoEventWireup="false" CodeFile="productos-administrar-BORRAR.aspx.vb" Inherits="productos_administrar_BORRAR" %>
                    ...
                    <div class="thumbnail">
                        <div class="caption-full">
                            ...
                            <form id="form1" runat="server" class="form-horizontal">
                                ...
                                <h3 style="text-align: right" class="gray">Eliminar Producto</h3>
                            ...
                            <!-- Formulario -->
                                ...
                                <br />
                                <a href = "productos-administrar-BORRAR.aspx" class = "btn" role = "button"><span class="glyphicon glyphicon-erase"></span>&nbsp Limpiar</a>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FacturacionConnectionString %>" SelectCommand="ELIMINAR_PRODUCTO" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
