<%@ Page Language="VB" AutoEventWireup="false" CodeFile="productos-categorias-adm-BORRAR.aspx.vb" Inherits="productos_categorias_adm_BORRAR" %>
...
<html lang="en"/>
    ...
    <head runat="server">
        ...
        <link rel="icon" href="img/leaf.png" type="image/x-icon"/>
            <title>Leaf :: Eliminar Categoria</title>
        <!-- Bootstrap Core CSS -->
                    ...
                    <div class="thumbnail">
                        <div class="caption-full">
                            ...
                            <form id="form1" runat="server" class="form-horizontal">
                                ...
                                <h3 style="text-align: right" class="gray">Eliminar Categoria</h3>
                            ...
                            <!-- Formulario -->
                                ...
                                <br />
                                <a href = "productos-categorias-adm-BORRAR.aspx" class = "btn" role = "button"><span class="glyphicon glyphicon-erase"></span>&nbsp Limpiar</a>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FacturacionConnectionString %>" SelectCommand="ELIMINAR_CATEGORIA" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
