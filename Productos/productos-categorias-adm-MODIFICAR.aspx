<%@ Page Language="VB" AutoEventWireup="false" CodeFile="productos-categorias-adm-MODIFICAR.aspx.vb" Inherits="productos_categorias_adm_MODIFICAR" %>
...
<html lang="en"/>
    ...
    <head runat="server">
        ...
        <link rel="icon" href="img/leaf.png" type="image/x-icon"/>
            <title>Leaf :: Modificar Categoria</title>
        <!-- Bootstrap Core CSS -->
            ...
            <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="list-group">
                            ...
                            <a href="productos-administrar.html" class="list-group-item"><span class="glyphicon glyphicon-folder-open"></span>&nbsp &nbsp Administrar Productos</a>
                        ...
                        <div class="list-group">
                            ...
                            <a href="productos-categorias-adm.html" class="list-group-item active"><span class="glyphicon glyphicon-folder-close"></span>&nbsp &nbsp Administrar Categorias</a>
                    ...
                    <div class="thumbnail">
                        <div class="caption-full">
                            ...
                            <form id="form1" runat="server" class="form-horizontal">
                                ...
                                <h3 style="text-align: right" class="gray">Modificar Categoria</h3>
                            ...
                            <!-- Formulario -->
                                ...
                                <br />
                                <a href = "productos-categorias-adm-MODIFICAR.aspx" class = "btn" role = "button"><span class="glyphicon glyphicon-erase"></span>&nbsp Limpiar</a>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FacturacionConnectionString %>" SelectCommand="MODIFICAR_CATEGORIA" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
