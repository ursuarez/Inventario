<%@ Page Language="VB" AutoEventWireup="false" CodeFile="productos-administrar-INSERTAR.aspx.vb" Inherits="productos_administrar_INSERTAR" %>
                    ...
                    <div class="thumbnail">
                        <div class="caption-full">
                            ...
                            <form id="form1" runat="server" class="form-horizontal">
                                ...
                                <h3 style="text-align: right" class="gray">Insertar Producto</h3>
                            ...
                            <!-- Formulario -->
                                ...
                                <br />
                                <a href = "productos-administrar-INSERTAR.aspx" class = "btn" role = "button"><span class="glyphicon glyphicon-erase"></span>&nbsp Limpiar</a>
