<%@ Page Language="VB" AutoEventWireup="false" CodeFile="productos-administrar.aspx.vb" Inherits="Productos_productos_administrar" %>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                    ...
                    <div class="list-group">
                        ...
                        <a href="productos-administrar.aspx" class="list-group-item active"><span class="glyphicon glyphicon-folder-open"></span>&nbsp &nbsp Administrar Productos</a>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        ...
                        <p><i><strong>Inserte, Modifique y Elimine </strong></i>registros de la base de datos de <strong>Productos</strong></p>
                        </br>
                        <div  align="right">
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        <p>
                            ...
                            <i class="med-font">
                                Utilice la opcion <strong>Insertar</strong> para agregar un nuevo Producto a la base de datos. </br>
                                Utilice la opcion <strong>Modificar</strong> para modificar los registros de algun Producto especificando su <strong>Clave.</strong> </br>
                                Utilice la opcion <strong>Eliminar</strong> para eliminar un Producto de la base de datos especificando su numero de <strong>Clave.</strong>
                            </i>
                        </p>
                    </div>
                </div>
