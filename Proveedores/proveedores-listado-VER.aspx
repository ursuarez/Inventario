        ...
        <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="list-group">
                        ...
                        <a href="proveedores-administrar.aspx" class="list-group-item"><span class="glyphicon glyphicon-folder-open"></span>&nbsp &nbsp Administrar Proveedores</a>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        ...
                        <form id="form1" runat="server" class="form-horizontal">
                            ...
                            <a href="proveedores-listado.aspx" class="btn btn-primary btn-sm" role="button"><span class="glyphicon glyphicon-triangle-left"></span>&nbsp &nbsp Regresar</a>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ServidorProyectoAdmonConnectionString %>" SelectCommand="MOSTRAR_PROVEEDOR" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
