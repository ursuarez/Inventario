<%@ Page Language="VB" AutoEventWireup="false" CodeFile="proveedores-listado.aspx.vb" Inherits="Proveedores_proveedores_listado" %>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        <p>
                            ...
                            <i class="med-font">
                                Utilice la opcion <strong>Buscar</strong> para buscar un Proveedor en especifico utilizando su <strong>Clave.</strong></br>
                                Utilice la opcion <strong>Ver Todos</strong> para visualizar todos los Proveedores de la base de datos.
                            </i>
                        </p>
                    </div>
                </div>
