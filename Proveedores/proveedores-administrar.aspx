<%@ Page Language="VB" AutoEventWireup="false" CodeFile="proveedores-administrar.aspx.vb" Inherits="Proveedores_proveedores_administrar" %>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="proveedoress-administrar.aspx" class="list-group-item active"><span class="glyphicon glyphicon-folder-open"></span>&nbsp &nbsp Administrar Clientes</a>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        ...
                        <h4>
                            <a href="#">Administrador de Proveedores</a>
                        </h4>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        <p>
                            ...
                            <i class="med-font">
                                Utilice la opcion <strong>Insertar</strong> para agregar un nuevo Proveedor a la base de datos. </br>
                                Utilice la opcion <strong>Modificar</strong> para modificar los registros de algun Proveedor especificando su <strong>Clave.</strong> </br>
                                Utilice la opcion <strong>Eliminar</strong> para eliminar un Proveedor   de la base de datos especificando su numero de <strong>Clave.</strong>
                            </i>
                        </p>
